...
import { HeartHandshake, ChevronRight, ChevronDown, Filter, ChevronsRightLeft, ChevronsLeftRight, LayoutGrid, List } from "lucide-react";
            ...
            <AlumniKanbanCard
              ...
              pipelineExtra={
                <div className="flex items-center gap-1.5 pt-0.5">
                  <span className="text-[10px] text-muted-foreground font-medium shrink-0">Cap {percent}%</span>
...
export default function PayForwardClient({
  ...
  useEffect(() => {
    ...
    const fetchBoard = async () => {
      ...
      const res = await getKanbanBoardCardsAction("pay_forward", activeStages, filters);
      ...
      <div className="bg-card border border-border/80 rounded-2xl p-1.5 px-3 shadow-2xs flex flex-row gap-2 items-center">
        ...
        {viewMode === "list" && (
          <Select value={stageFilter} onValueChange={setStageFilter}>
            <SelectTrigger className="h-8 w-[180px] text-xs bg-muted bg-muted/60 hover:bg-muted/80 rounded-lg mr-2">
