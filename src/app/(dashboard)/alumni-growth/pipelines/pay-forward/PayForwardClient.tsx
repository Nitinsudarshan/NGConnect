...
function PayForwardColumn({ stage, activeStages, filters, userEmail, collapsed, setCollapsed }: { stage: any, activeStages: any[], filters: any, userEmail: string, collapsed: boolean, setCollapsed: (v: boolean) => void }) {
