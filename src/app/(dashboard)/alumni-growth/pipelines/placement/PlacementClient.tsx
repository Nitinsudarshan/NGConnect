...
import { Briefcase, ChevronDown, Filter, ChevronsRightLeft, ChevronsLeftRight, LayoutGrid, List } from "lucide-react";
...
export default function PlacementClient({
  ...
  useEffect(() => {
    ...
    const fetchBoard = async () => {
      ...
      const res = await getKanbanBoardCardsAction("placement", activeStages, filters);
