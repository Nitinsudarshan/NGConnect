...
export function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center bg-transparent py-8 transition-all duration-500">
      <div className="w-full max-w-[420px] bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden border border-slate-100 dark:border-slate-800 animate-in zoom-in-95 duration-500">
        <Toaster />
        <div className="p-8 md:p-10">
          <header className="text-center mb-8">
            <div className="flex justify-center mb-6">
              <LoadingSpinner size="md" showRing={false} />
            </div>
            <h1 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white tracking-tight">
              Welcome
            </h1>
            <p className="text-slate-500 dark:text-slate-400 mt-2.5 text-sm font-medium px-2">
